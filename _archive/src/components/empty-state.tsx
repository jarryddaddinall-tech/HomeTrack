...
export function EmptyState({ icon, title, description, variant }: EmptyStateProps) {
  ...
  return (
    <div className="rounded-xl border-2 border-dashed border-slate-100 bg-slate-50/50 p-8 text-center shadow-soft-sm transition-colors hover:border-slate-200">
      <div
